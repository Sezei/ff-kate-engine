-- UI from: https://raw.githubusercontent.com/bloodball/UI-Librarys/main/Material.
-- Modified to meet today's standards
...
function Material.Load(Config)
	...
	local Open = Config.OpenByDefault or true
